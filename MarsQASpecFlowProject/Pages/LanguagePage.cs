...
namespace MarsQASpecFlowProject.Pages
{
    public class LanguagePage : CommonDriver
    {
        ...
        public void fillTextField(String lang)
        {               
        ...
        public void selectValue(String dvalue)
        {
    ...
    public void languageUpdateBtn()
        ...
        public void updateLanguage(String lang, String langone, String levelone)
        {
            ...
            foreach (var row in rows)
            {
               ...
               // Check if the language matches the provided text
                if (languageText.Equals(lang))
                {
                    ...
                    fillTextField(langone);
                    selectValue(levelone);
                    languageUpdateBtn();
                }
            }
        }
